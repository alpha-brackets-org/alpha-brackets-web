...
function Portfolio() {
  ...
  return (
    <section className="work-card pt-140 mb-140">
            ...
            <div>
              ...
              <h2 className="fw-600 d-rotate wow">
                <span className="rotate-text">
                  Proven <span className="fw-200">Results.</span>
                </span>
              </h2>
            </div>
      ...
      {/* <div className="sec-bottom mt-140">
        <div className="main-bg d-flex align-items-center">
          <h6 className="fz-14 fw-400">
            More than <b className="fw-600"> 200+ companies </b> trusted us worldwide
          </h6>
        </div>
      </div> */}
    </section>
