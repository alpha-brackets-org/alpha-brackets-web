...
function Marq2() {
  const marquess = ['Have an idea?', "Let's connect"]; // Replace with your actual array
  const AllMarquess = Array(6).fill(marquess).flat();
  const contact = ['+92-321-7862291', "hello@webfolio.com"]; // Replace with your actual array
