        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((item, i) => (
            <div key={i} className="group relative">
              <div className="relative rounded-2xl bg-card border border-border/50 overflow-hidden hover:border-primary/30 transition-all duration-500 flex flex-col hover:-translate-y-1">
                {/* Image Container */}
                <div className="relative aspect-[4/5] overflow-hidden bg-muted/20">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-black/40">
                    <Link
                      href="#0"
                      className="w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all -translate-y-4 group-hover:translate-y-0 duration-300 delay-75"
                    >
                      <Facebook className="w-4 h-4" />
                    </Link>
                    <Link
                      href="#0"
                      className="w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all -translate-y-4 group-hover:translate-y-0 duration-300 delay-100"
                    >
                      <Behance className="w-4 h-4" />
                    </Link>
                    <Link
                      href="#0"
                      className="w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all -translate-y-4 group-hover:translate-y-0 duration-300 delay-150"
                    >
          ...
          <div className="group relative">
            ...
            >
              ...
              <div className="w-16 h-16 rounded-full border border-primary/30 flex items-center justify-center group-hover:bg-primary group-hover:text-primary-foreground transition-all">
